...
using Master.Common;
using Master.DTOs;
using Master.Features.Authorization.Commands.ChangePassword;
using Master.Features.Authorization.Commands.DeleteProfile;
using Master.Features.Authorization.Commands.EditProfile;
using Master.Features.Authorization.Commands.LoginUser;
using Master.Features.Authorization.Commands.RefreshToken;
using Master.Features.Authorization.Commands.RegisterUser;
using Master.Features.Authorization.Commands.RevokeToken;
using MediatR;
